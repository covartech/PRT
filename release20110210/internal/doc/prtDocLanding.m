...
%
% This is the Beta release of the Pattern Recognition Toolbox (PRT).
% Only limited documentation is included in this release.
% For the most up to date PRT documenation visit
