...
functionNames = {'prtTestDistance','prtTestClass', 'prtTestFeatSelExhaustive', 'prtTestClassFLD',' prtTestFeatSelSfs', 'prtTestClassKnn','prtTestKernelRbf','prtTestPreProcZmuv','prtTestRegressGP','prtTestScoreAuc','prtTestDataSetClass','prtTestDataSetRegress','prtTestDataSetStandard', 'prtTestRvMvn'};
