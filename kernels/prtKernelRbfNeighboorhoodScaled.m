classdef prtKernelRbfNeighboorhoodScaled < prtKernel
    % prtKernelRbfNeighboorhoodScaled  Radial basis function kernel where
    % each entry is scaled according to the distance to neighbors in the
    % training set.
    %
    %  KERNOBJ = prtKernelRbfNeighboorhoodScaled Generates a kernel object
    ...
    %  feature space.
    % 
    %  KERNOBJ = prtKernelRbfNeighboorhoodScaled(PROPERTY1, VALUE1, ...) constructs a
    %  prtKernelRbfNdimensionScale object KERNOBJ with properties as specified by
    %  PROPERTY/VALUE pairs. prtKernelRbfNeighboorhoodScaled objects have the following
    ...
    %   k1 = prtKernelRbfNeighboorhoodScaled;    % Create a prtKernel object with 
    %                                            % default value of neighborhoodPercentile
    %   k2 = prtKernelRbfNeighboorhoodScaled('neighborhoodPercentile',2); % Create a prtKernel object with
