function [DataSet,pcaVectors] = prtDataPca(N)
%[DataSet,pcaVectors] = prtDataPca(N)
%
%   [DataSet,truePcaVectors] = prtDataPca(300);
%   tpv = truePcaVectors;
%   pca = prtPreProcPca;
...
DataSet = prtDataSetClass(X,Y,'name','prtDataPca');