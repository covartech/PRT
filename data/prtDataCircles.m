function DataSet = prtDataCircles
%prtDATACIRCLES   Generates some circle clustered example data for the prt.
%
% Syntax: [X, Y] = prtDataCircles
%
% Inputs: 
%   none
%
...
%
% See also: prtDataUnimodal, prtDataBimodal, prtDataSpiral
...
DataSet = prtDataSetClass(X,Y,'name','prtDataCircles');