classdef classifier < prt.action
    ...
    methods (Access = protected)
        ...
        function ClassObj = preTrainProcessing(ClassObj, DataSet)
            ...
            ClassObj = preTrainProcessing@prt.action(ClassObj,DataSet);
        end
        ...
        function OutputDataSet = postRunProcessing(ClassObj, OutputDataSet)
            ...
            OutputDataSet = postRunProcessing@prt.action(ClassObj, OutputDataSet);
        end
