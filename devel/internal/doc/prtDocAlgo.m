...
% prtAlgorithm objects allow you to combie together prtAction objects, and
...
% + and - operators. Consider this simple example, connecting a pre
% processing object with classifier, in series.
...
% To add an object to the right of the processing chain, use the +
% operator. To add an object to the left, use the - operator. Suppose for
% example, you wanted to add a decision object after the prtClass object,
...
plot(algo)
%%
% Note, this is not a particularly good classifier, it is meant to be a
% simple example of how to combine prtActions into a prtAlgorithm.
...
% the third classifier in the previous example. You could do so in the
% following manner:
